...
<head>
    ...
    <title>Papergrid A4 Notebook-Pack of 4</title>
    ...
    <%@include file="Navbar_Stationary.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/notebook2.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/notebook2.jpeg" width="60px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/notebook2.1.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/notebook2.2.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/notebook2.3.jpeg" width="60px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Stationary-1.jsp">  <p class="responsive1">Stationaries / Notebooks</p></a>
                        <h3 class="responsive">Papergrid Unruled A4 Notebook 384 Pages  (Multicolor, Pack of 4)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 600</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                    <a href="" class="btnn" onclick="add_to_cart('p126','Papergrid A4 Notebook-Pack of 4',600)"><b>Add to cart</b></a>   
                       
                    
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Papergrid Unruled A4 Notebook 384 Pages (Multicolor, Pack of 4), Papergrid uses finest quality of paper to bring you the</p>
