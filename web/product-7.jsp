...
<head>
    ...
    <title>Poco F1 Armoured Edition</title>
    ...
    <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone6.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone6.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone6.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone6.2.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone6.4.jpeg" width="50px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">POCO F1 (Armoured Edition, 256 GB)  (8 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 22,999</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 30,999</small></strike><small class="change2"><b>&nbsp; 25% off</b></small></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                      ...
                      <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p7'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>POCO F1 (Armoured Edition, 256 GB) (8 GB RAM) | Expandable Upto 256 GB, 15.7 cm (6.18 inch)</p>
                     <p class="down">Full HD+ Display, 12MP + 5MP | 20MP Front Camera, 4000 mAh Li-polymer Battery, Qualcomm</p> 
                     <p class="down">Snapdragon 845 Processor.</p> 
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 feature-box6">
                                ...
                                <h6 class="price">&#8377; 49images/,990</h6>
                                </div>
                            </div>
