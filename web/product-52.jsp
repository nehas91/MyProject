...
<head>
    ...
    <title>Kurlon Klassic Queen Box Bed</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/bed12.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/bed12.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed12.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed12.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed12.3.jpeg" width="90px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Furniture2.jsp">  <p class="responsive1">Furnitures / Beds</p></a>
                        <h3 class="responsive">Kurlon Klassic Engineered Wood Queen Box Bed </h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 20,613</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p52','Kurlon Klassic Queen Box Bed',20613)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Kurlon Klassic Engineered Wood Queen Box Bed  (Finish Color - Wenge), Bed Material Subtype: Particle Board</p>
                     <p class="down">W x H x D: 152 cm x 80 cm x 198 cm (4 ft 11 in x 2 ft 7 in x 6 ft 5 in), Recommended Mattress Size: 1981.1x1524</p> 
                     <p class="down">Storage Type: Box, Condition: Knock Down - Delivered in non-assembled pieces, installation by service partner.</p> 
                </div>
