...
<head>
    ...
    <title>SS MASTER 1500 Cricket Bat</title>
     ...
     <%@include file="Navbar_Sports.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/cricket9.2.jpeg" id="ProductImg6">
                        <div class="small-img-row" id="c7">
                            <div class="small-img-col">
                                <img src="images/cricket9.2.jpeg" width="50px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket9.1.jpeg" width="50px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket9.2.jpeg" width="50px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket9.1.jpeg" width="50px" height="70px" class="change3">
                            </div>
                ...
                <div class="change" id="c8">
                    <a href="Sports Items-1.jsp">  <p class="responsive1">Sports Items / Cricket gears</p></a>
                        <h3 class="responsive">SS MASTER 1500 English Willow Cricket Bat</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 5,397</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                       <a href="" class="btnn" onclick="add_to_cart('p109','SS MASTER 1500 Cricket Bat',5397)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>SS Master 1500 cricket bat is best suited for intermediate cricket player with attacking playing style. It is made from Grade 3</p>
                     <p class="down">English Willow with good willow profile. Player will get 3 to 6 clear grains in the bat with straight grains. Sweet Spot is located</p> 
                     <p class="down"> to mid to low position and extended to toe area. This type of configuration gives best swing and pickup to hard hitting.</p> 
                </div>
