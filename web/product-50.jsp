...
<head>
    ...
    <title>Spacewood Hydraulic Bed</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/bed10.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/bed10.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed10.1.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed10.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed10.3.jpeg" width="90px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Furniture2.jsp">  <p class="responsive1">Furnitures / Beds</p></a>
                        <h3 class="responsive">Spacewood Engineered Wood Queen Hydraulic Bed</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 21,690</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p50','Spacewood Hydraulic Bed',21690)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Spacewood Engineered Wood Queen Hydraulic Bed  (Finish Color - Vermont), Bed Material Subtype: Particle Board</p>
                     <p class="down">W x H x D: 160 cm x 90 cm x 209 cm (5 ft 2 in x 2 ft 11 in x 6 ft 10 in), Storage Type: Hydraulic, Recommended Mattress</p> 
                     <p class="down">Size: Length = 78 inches x Width = 60 inches, Delivery Condition: Knock Down - Delivered in non-assembled pieces, installation by service partner.</p> 
                </div>
