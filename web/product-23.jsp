...
<head>
    ...
    <title>Dell G3 Series Core i5</title>
          ...
          <li><a href="#" data-toggle="modal" data-target="#cart"><i class="fa fa-shopping-basket"></i><span class="cart-items">( 0 )</span></a></li>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/laptop10.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/laptop10.jpeg" width="100px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop10.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop10.2.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop10.3.jpeg" width="100px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">Dell G3 Series Core i5 8th Gen 3579 Gaming Laptop</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 89,650</strong></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     ...
                     <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p23'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Dell G3 Series Core i5 8th Gen - (8 GB/1 TB HDD/128 GB SSD/Windows 10 Home/4 GB Graphics</p>
                     <p class="down">/NVIDIA Geforce GTX 1050) 3579 Gaming Laptop  (15.6 inch, Licorice Black, 2.53 kg, With MS Office)</p> 
                     <p class="down">, 15.6 inch Full HD LED Backlit Anti-glare Display(60 Hz Refresh Rate).</p> 
                </div>
