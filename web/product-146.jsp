...
<head>
    ...
    <title>FLAIR Ball Pen-(Pack of 50)</title>
    ...
    <%@include file="Navbar_Stationary.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/pen10.jpeg" id="ProductImg14">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/pen10.jpeg" width="60px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen10.1.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen10.3.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen10.jpeg" width="60px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Stationary-2.jsp">  <p class="responsive1">Stationaries / Pens</p></a>
                        <h3 class="responsive">FLAIR Ball Pen-(Pack of 50)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 999</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                    <a href="" class="btnn" onclick="add_to_cart('p146','FLAIR Ball Pen-(Pack of 50)',999)"><b>Add to cart</b></a>   
                       
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>FLAIR Ball Pen-(Pack of 50), flair writometer ball pen pack of 50 pieces narrow nib and smooth writing in multicolour</p>
                     <p class="down">Body Color: Red, Blue, Gold, Black, flair uses less plastic to save environment and also writes more than 10 times from other</p> 
                     <p class="down">ordinary pens, 10 days replacement policy available, cash on delivery available.</p> 
                </div>
