...
<head>
    ...
    <title>KAKSS Fixed Weight Dumbbells</title>
     ...
     <%@include file="Navbar_Sports.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/homegym9.jpeg" id="ProductImg8">
                        <div class="small-img-row" id="c4">
                            <div class="small-img-col">
                                <img src="images/homegym9.jpeg" width="70px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym9.1.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym9.2.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym9.jpeg" width="70px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change" id="c10">
                    <a href="Sports Items-2.jsp">  <p class="responsive1">Sports Items / Home gyms</p></a>
                        <h3 class="responsive">KAKSS HEX Rubber Dumbbell Fixed Weight Dumbbell  (22.5 kg)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 6,999</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                       <a href="" class="btnn" onclick="add_to_cart('p122','KAKSS Fixed Weight Dumbbells',6999)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>KAKSS HEX Rubber Dumbbell Fixed Weight Dumbbell (22.5 kg), Model Name: HEX Rubber Dumbbell, Part Number: Pair of 1</p>
                     <p class="down">Type: Fixed Weight Dumbbell, Weight: 22.5 kg, Width: 10 inch, Color: Black, For: Boys, Men, Girls, Women, Senior, Junior</p> 
                     <p class="down">Cash on delivery available.</p> 
                </div>
