...
<head>
    ...
    <title>RoyalOak Jenny Fabric Sofa</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/sofa8.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sofa8.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa8.1.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa8.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa8.3.jpeg" width="90px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                       <a href="Furniture1.jsp"> <p class="responsive1">Furnitures / Sofa</p></a>
                        <h3 class="responsive">RoyalOak Jenny Fabric 2 Seater Sofa  (Finish Color - Grey)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 27,060</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p39','RoyalOak Jenny Fabric Sofa',27060)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>RoyalOak Jenny Fabric 2 Seater Sofa  (Finish Color - Grey), Upholestry: Cotton, Filling Material: Pocket Springs</p>
                     <p class="down">W x H x D: 147.32 cm x 90.17 cm x 81.28 cm (4 ft 9 in x 2 ft 11 in x 2 ft 7 in), Symmetrical, Delivery Condition:</p> 
                     <p class="down">Knock Down - Delivered in non-assembled pieces, installation by service partner.</p> 
                </div>
