...
<head>
    ...
    <title>Lancer Men Navy Sports Sandals</title>
    ...
    <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal7.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal7.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal7.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal7.2.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal7.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Lancer Men Navy Sports Sandals</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 734</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 1,049</small></strike><small class="change2"><b>&nbsp; 30% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p71','Lancer Men Navy Sports Sandals',734)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Lancer Men Navy Sports Sandals, Type-Sports Sandals, Upper Pattern-Solid, Closure-Velcro, Type for Flats-</p>
                     <p class="down">Sandal, Color-Navy, Pack of-1, Sole Material-Phylone, Generic Name-Sandal. A light weight good quality</p> 
                     <p class="down">product. Flexible and Comfortable to wear.</p> 
                </div>
