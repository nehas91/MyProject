...
<head>
    ...
    <title>Star X PVC Home Gym Combo</title>
     ...
     <%@include file="Navbar_Sports.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/homegym10.jpeg" id="ProductImg8">
                        <div class="small-img-row" id="c4">
                            <div class="small-img-col">
                                <img src="images/homegym10.jpeg" width="70px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym10.1.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym10.2.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym10.3.jpeg" width="70px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change" id="c10">
                    <a href="Sports Items-2.jsp">  <p class="responsive1">Sports Items / Home gyms</p></a>
                        <h3 class="responsive">Star X PVC 50 Kg Home Gym Combo</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 3,999</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                       <a href="" class="btnn" onclick="add_to_cart('p121','Star X PVC Home Gym Combo',3999)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Star X 50 kg PVC 50KG COMBO WITH 3FT CURL AND 5FT STRAIGHT ROD AND ACCESSORIES Home Gym Combo, 50 Kg of PVC</p>
                     <p class="down">Weight ( 5 Kg x 6 = 30 Kg + 3 Kg x 4 = 12Kg + 2 Kg x 4 = 8Kg ), 1 x 5 feet plain rod + 1 x 3 feet Curl Rod + 2 x 14 " dumbbell</p> 
                     <p class="down">Rods, 100% pure leather gym gloves + 1 Gym Backpack + 1 Skipping Rope + 1 Hand Gripper + 4 Locks and clippers comes with rods,
                    </p> 
                </div>
