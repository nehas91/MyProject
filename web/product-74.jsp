...
<head>
    ...
    <title>Puma Men's Blue Color Sandals</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal11.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal11.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal11.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal11.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal11.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Puma Men's Blue Color Sandals</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 1,749</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p74','Puma Mens Blue Color Sandals',1749)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Puma Men's Blue Color Sandals, Closure-Velcro, Color-Blue, Pack of-1, Sole Material-Rubber, Care instructions</p>
                     <p class="down">Wipe with a clean dry cloth. The horizontal strap which covers your feet partially assures perfect fit and comfort.</p> 
                     <p class="down">Velcro strap for easy step in and outRubber outsole for gripPUMA logo on the strap.</p> 
                </div>
