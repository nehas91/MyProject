...
<head>
    ...
    <title>Acer Predator Helios 300</title>
          ...
          <li><a href="#" data-toggle="modal" data-target="#cart"><i class="fa fa-shopping-basket"></i><span class="cart-items">( 0 )</span></a></li>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/laptop1.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/laptop1.jpeg" width="100px" height="70px" class="change3" id="change4">
                            </div>
                 
                            <div class="small-img-col">
                                <img src="images/laptop1.2.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop1.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop1.3.jpeg" width="100px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">Acer Predator Helios 300 Core i5 7th Gen Gaming Laptop</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 90,999</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 129,999</small></strike><small class="change2"><b>&nbsp; 30% off</b></small></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     ...
                     <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p19'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Acer Predator Helios 300 Core i5 7th Gen - (8 GB/1 TB HDD/128 GB SSD/Windows 10 Home/4 GB </p>
                     <p class="down">Graphics/NVIDIA Geforce GTX 1050Ti) G3-572 Gaming Laptop  (15.6 inch, Black, 2.7 kg), NVIDIA</p> 
                     <p class="down">Geforce GTX 1050Ti for Desktop Level Performance, Pre-installed Genuine Windows 10 OS.</p> 
                </div>
