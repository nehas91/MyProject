    ...
    <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone4.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone4.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone4.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone4.4.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone4.3.jpeg" width="40px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">OPPO F11 Pro (Aurora Green, 128 GB)  (6 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 17,990</strong></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                        ...
                        <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p6'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>OPPO F11 Pro (Aurora Green, 128 GB) (6 GB RAM) | Expandable Upto 256 GB, 16.51 cm (6.5 inch) Full</p>
                     <p class="down">HD+ Display, 48MP + 5MP | 16MP Front Camera, 4000 mAh Li-polymer Battery,  MediaTek Helio P70</p> 
                     <p class="down">Octa Core 2.1 GHz Processor.</p> 
                </div>
