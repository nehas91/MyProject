    ...
    <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone16.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone16.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone16.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone16.2.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone16.3.jpeg" width="40px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                       <a href="Electronics-1.jsp"><p class="responsive1">Electronics / Mobiles</p></a>
                        <h3 class="responsive">Honor 10 Lite (Sky Blue, 64 GB) (6 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-o"></i>
                    <h4 class="rate"><strong>&#8377; 13,999</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 20,999</small></strike><small class="change2"><b>&nbsp; 35% off</b></small></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                       ...
                       <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p2'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Honor 10 Lite (Sky Blue, 64 GB)  (6 GB RAM) | Expandable Upto 512 GB, 15.77 cm (6.21 inch)</p>
                     <p class="down">Full HD+ Display, 13MP + 2MP | 24MP Front Camera 3400 mAh Lithium Polymer Battery</p> 
                     <p class="down">,Kirin 710 2.2GHz Octa Core Processor</p> 
                </div>
