          ...
          <li><a href="#" data-toggle="modal" data-target="#cart"><i class="fa fa-shopping-basket"></i><span class="cart-items">( 0 )</span></a></li>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/laptop3.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/laptop3.jpeg" width="100px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop3.4.jpeg" width="100px" height="60px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop3.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop3.5.jpeg" width="100px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Electronics-2.jsp"><p class="responsive1">Electronics / Mobiles</p></a>
                        <h3 class="responsive">HP Pavilion x360 Core i5 8th Gen Laptop</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 71,990</strong></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     ...
                     <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p16'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>HP Pavilion x360 Core i5 8th Gen - (8 GB/1 TB HDD/Windows 10 Home) 14-dh0150TU 2 in 1 Laptop </p>
                     <p class="down">(14 inch, Mineral Silver, 1.65 kg, With MS Office), Carry It Along 2 in 1 Laptop, 14 inch Full HD LED</p> 
                     <p class="down">Backlit Display, Light Laptop without Optical Disk Drive.</p> 
                </div>
