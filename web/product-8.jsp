   ...
   <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone5.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone5.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone5.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone5.2.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone5.3.jpeg" width="10px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                     <a href="Electronics-1.jsp"><p class="responsive1">Electronics / Mobiles</p></a>
                        <h3 class="responsive">Redmi K20 Pro (Glacier Blue, 128 GB)  (6 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 26,999</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 28,999</small></strike><small class="change2"><b>&nbsp; 6% off</b></small></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                         ...
                         <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p8'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Redmi K20 Pro (Glacier Blue, 128 GB) (6 GB RAM), 16.23 cm (6.39 inch) Full HD+ Display,  48MP+</p>
                     <p class="down">13MP + 8MP | 20MP Front Camera, 4000 mAh Li-polymer Battery, Qualcomm Snapdragon 855</p> 
                     <p class="down">Processor.</p> 
                </div>
