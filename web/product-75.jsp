...
<head>
    ...
    <title>Sparx Men's Casual Sandals</title>
    ...
    <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal12.2.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal12.2.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal12.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal12.3.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal12.2.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Sparx Men Blue, Orange Casual Sandal</h3>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p75','Sparx Mens Casual Sandals',1299)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Sparx Men Blue, Orange Casual Sandal, Color-Blue,Orange, Pack of-1, Type-Casual, Type for Flats-Sandal</p>
                     <p class="down">The sandals for men, made with rubber outsole which provide added flexibility and comfort. The horizontal</p> 
                     <p class="down">strap which covers your feet partially assures perfect fit and comfort.</p> 
                </div>
