    ...
    <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone10.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone10.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone10.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone10.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone10.2.jpeg" width="10px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">Vivo U10 (Thunder Black, 32 GB) (3 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 10,990</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 11,999</small></strike><small class="change2"><b>&nbsp; 10% off</b></small></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p12'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%=pid%>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Vivo U10 (Thunder Black, 32 GB) (3 GB RAM) | Expandable Upto 256 GB, 16.13 cm (6.35 inch) HD+</p>
                     <p class="down">Display, 13MP + 8MP + 2MP | 8MP Front Camera, 5000 mAh Li-ion Battery, 5000 mAh Li-ion Battery</p> 
                     <p class="down">Qualcomm Snapdragon 665 AIE Processor, 18 W Fast Charging.</p> 
                </div>
