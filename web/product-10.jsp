    ...
    <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone8.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone8.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone8.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone8.2.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone8.4.jpeg" width="40px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                       <a href="Electronics-1.jsp"><p class="responsive1">Electronics / Mobiles</p></a>
                        <h3 class="responsive">Realme 3 Pro (Lightning Purple, 128 GB) (6 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 16,999</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 19,999</small></strike><small class="change2"><b>&nbsp; 15% off</b></small></h4>
                    ...
                    <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p10'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Realme 3 Pro (Lightning Purple, 128 GB) (6 GB RAM) | Expandable Upto 256 GB, 16.0 cm (6.3 inch)</p>
                     <p class="down">Full HD+ Display, 16MP + 5MP | 25MP Front Camera, 4045 mAh Battery, Qualcomm Snapdragon</p> 
                     <p class="down">710 Octa Core 2.2 GHz AIE Processor, VooC Flash Charge 3.0, Dual Nano SIM Slot and Memory Card Slot.</p> 
                </div>
