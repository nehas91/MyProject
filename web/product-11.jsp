    ...
    <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone12.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone12.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone12.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone12.2.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone12.3.jpeg" width="10px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">Samsung Galaxy A51 (Prism Crush Blue, 128 GB) (6 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 23,999</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 25,999</small></strike><small class="change2"><b>&nbsp; 7% off</b></small></h4>
                   ...
                   <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p11'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Samsung Galaxy A51 (Prism Crush Blue, 128 GB) (6 GB RAM) | Expandable Upto 512 GB, 16.26 cm</p>
                     <p class="down">(6.4 inch) Full HD+ Display, 48MP + 12MP + 5MP + 5MP | 32MP Front Camera, 4000 mAh Lithium</p> 
                     <p class="down">-ion Battery, Exynos 9611 Processor.</p> 
                </div>
