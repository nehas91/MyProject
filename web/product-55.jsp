...
<head>
    ...
    <title>Bata PERIN Lace Up For Men</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/shoe2.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe2.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe2.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe2.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe2.2.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Bata PERIN Lace Up For Men  (Black)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 4,999</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p55','Bata PERIN Lace Up For Men',4999)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Bata PERIN Lace Up For Men (Black), Color-Black, Outer Material-Leather, Model Name-PERIN, Occasion-Formal</p>
                     <p class="down">Sole Material-PU, Closure-Lace-Ups, Upper Pattern-Solid, Experience great comfort walking in this pair of shoes</p> 
                     <p class="down">from the house of BATA Featuring a contemporary refined design with exceptional comfort, this pair is perfect to give your quintessential dressing an upgrade.</p> 
                </div>
