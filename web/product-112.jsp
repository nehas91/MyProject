...
<head>
    ...
    <title>Kookaburra KB Cricket Bat</title>
    ...
    <%@include file="Navbar_Sports.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/cricket12.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/cricket12.jpeg" width="20px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket12.4.jpg" width="20px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket12.jpeg" width="20px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket12.4.jpg" width="20px" height="100px" class="change3">
                            </div>
                ...
                <div class="change">
                    <a href="Sports Items-1.jsp">  <p class="responsive1">Sports Items / Cricket gears</p></a>
                        <h3 class="responsive">Kookaburra KB Kahuna 1000 English Willow Cricket Bat</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 4,740</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                       <a href="" class="btnn" onclick="add_to_cart('p112','Kookaburra KB Cricket Bat',4740)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Kookaburra KB Kahuna 1000 English Willow Cricket Bat, Age Group-14+, Blade Made of English Willow, Beginner,Intermediate </p>
                     <p class="down">Playing Level, Bat Grade: Grade 1, Sport Type: Cricket, With Cover, Weight Range 1020 - 1200 g, Color of bat-Beige, Suitable for </p> 
                     <p class="down">Leather Ball, Handle Grip Type-Octopus, Handle Material-Sarawark Cane Handle.</p> 
                </div>
