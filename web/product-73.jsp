...
<head>
    ...
    <title>Adidas Men's Black Sandals</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal9.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal9.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal9.2.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal9.3.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal9.4.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Adidas Men's Black Sandals</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 2,799</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p73','Adidas Mens Black Sandals',2799)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Adidas Men's Black Sandals, Closure-Velcro, Type for Flats-Sandal, Color-Black, Pack of-1, Sole Material-Rubber</p>
                     <p class="down">Inner Material-Synthetic, Insole Material-Synthetic, Weight-500 g (per single Sandal)-Weight of the product may</p> 
                     <p class="down">vary depending on size.</p> 
                </div>
