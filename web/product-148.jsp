...
<head>
    ...
    <title>Montex Mint Ball Pen-Pack of 50</title>
    ...
    <%@include file="Navbar_Stationary.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/pen11.1.jpeg" id="ProductImg14">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/pen11.1.jpeg" width="60px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen11.2.jpg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen11.1.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen11.2.jpg" width="60px" height="70px" class="change3">
                            </div>
                ...
                <div class="change">
                      <a href="Stationary-2.jsp">  <p class="responsive1">Stationaries / Pens</p></a>
                        <h3 class="responsive">Montex Mint Ball Pen-Pack of 50</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 500</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                   <a href="" class="btnn" onclick="add_to_cart('p148','Montex Mint Ball Pen-Pack of 50',500)"><b>Add to cart</b></a>   
                       
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Montex Mint Ball Pen-Pack of 50, Montex Mint ball pen pack of 50 pieces narrow nib and smooth writing in multicolour</p>
                     <p class="down">Body Color: Red, Blue, Black, This pen uses less plastic to save environment and also writes more than 10 times from other</p> 
