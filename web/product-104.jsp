...
<head>
    ...
    <title>CEAT English Willow Cricket Bat</title>
   ...
   <%@include file="Navbar_Sports.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/cricket5.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/cricket5.jpeg" width="20px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket5.3.jpeg" width="20px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket5.jpeg" width="20px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/cricket5.3.jpeg" width="20px" height="100px" class="change3">
                            </div>
                ...
                <div class="change">
                    <a href="Sports Items-1.jsp">  <p class="responsive1">Sports Items / Cricket gears</p></a>
                        <h3 class="responsive">CEAT Milaze JR - Size Harrow English Willow Cricket Bat  (1020 - 1080 g)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 6,160</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                      <a href="" class="btnn" onclick="add_to_cart('p104','CEAT English Willow Cricket Bat',6160)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>CEAT Milaze JR - Size Harrow English Willow Cricket Bat (1020 - 1080 g), Age Group-14+, Blade Made of English Willow, Beginner</p>
                     <p class="down">Playing Level, Bat Grade: Grade 3, Sport Type: Cricket, With Cover, Weight Range 1020 - 1080 g, Color-Beige, Blue, Suitable for </p> 
                     <p class="down">Leather Ball, Handle Grip Type-Rubber, Handle Material-Wood.</p> 
                </div>
