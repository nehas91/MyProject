...
<head>
    ...
    <title>Realme6 Comet Blue</title>
    ...
    <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone3.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone3.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone3.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone3.2.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone3.3.jpeg" width="50px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">Realme 6 (Comet Blue, 64 GB)  (6 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 15,999</strong></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                      ...
                      <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p5'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Realme 6 (Comet Blue, 64 GB) (6 GB RAM) | Expandable Upto 256 GB, 16.51 cm (6.5 inch) Full HD+</p>
                     <p class="down">Display, 64MP + 8MP + 2MP + 2MP | 16MP Front Camera, 4300 mAh Battery MediaTek Helio G90T</p> 
                     <p class="down">Processor, 90 Hz Ultra Smooth Display, 30 W Flash Charge, Side Fingerprint Sensor.</p> 
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 feature-box7">
                                <a href="product-1.jsp"><img src="images/phone15.jpeg"></a>
                                <div class="rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                ...
                                <div class="caption1">
                                <h6 class="change5">Realme5 Crystal Blue</h6>
                                <h6 class="price">&#8377; 11,999</h6>
                                </div>
                            </div>
