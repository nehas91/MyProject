...
<head>
    ...
    <title>Puma MAPM Cat X Mid Sneakers</title>
    ...
    <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/shoe5.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe5.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe5.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe5.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe5.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Puma MAPM Kart Cat X Mid Sneakers For Men  (Black)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 5,699</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 9,999</small></strike><small class="change2"><b>&nbsp; 43% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p57','Puma MAPM Cat X Mid Sneakers',5699)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Puma MAPM Kart Cat X Mid Sneakers For Men (Black), Developed from a resilient compound of hexagonal cells,</p>
                     <p class="down">LQDCELL keeps you stable, and secure with shock aborsption and cushioning in every step DETAILS Mid-top</p> 
                     <p class="down">silhouetteSynthetic upper with stitched detailsInternal lace woven system with ankle cross.</p> 
                </div>
