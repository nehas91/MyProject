...
<head>
    ...
    <title>Snipper Gym Accessories/Kit</title>
    ...
    <%@include file="Navbar_Sports.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/homegym4.jpeg" id="ProductImg8">
                        <div class="small-img-row" id="c4">
                            <div class="small-img-col">
                                <img src="images/homegym4.jpeg" width="70px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym4.2.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym4.3.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym4.jpeg" width="70px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change" id="c10">
                    <a href="Sports Items-2.jsp">  <p class="responsive1">Sports Items / Home gyms</p></a>
                        <h3 class="responsive">Snipper Gym Accessories/Kit & Fitness Kit</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 1,999</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                      <a href="" class="btnn" onclick="add_to_cart('p115','Snipper Gym Accessories/Kit',1999)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Snipper Gym Combo Of Premium Leatkherite (Black) Gym Bag, Lycra Open Gym Gloves With Wrist Support (Black) And</p>
                     <p class="down">Spider Shaker With 2 Extra Storage Compartment (Red) Gym And Fitness Kit/Gym Combo/Gym Accessories/Gym Kit Gym</p> 
                     <p class="down"> & Fitness Kit, Snipper strong Gym Bag strong It Is Superior Quality Gym Bag.</p> 
                </div>
