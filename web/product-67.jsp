...
<head>
    ...
    <title>Puma Men Grey Color Sandal</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal2.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal2.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal2.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal2.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal2.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Puma Men Grey Color Sandal</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 1,649</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p67','Puma Men Grey Color Sandal',1649)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Puma Men Grey Color Sandal, Closure-Velcro, Type for Flats-Sandal, Color-Grey, Leather Type-Nubuck</p>
                     <p class="down">Tanning Process-Synthetic, Sole Material-Rubber, Removable Insole-No, Care instructions-Wipe with a </p> 
                     <p class="down">clean dry cloth, Weight-250 g (per single Sandal) - Weight of the product may vary depending on size.</p> 
                </div>
