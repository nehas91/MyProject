...
<head>
    ...
    <title>Wakefit Sheesham Queen Bed</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/bed11.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/bed11.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed11.1.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed11.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed11.3.jpeg" width="90px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Furniture2.jsp">  <p class="responsive1">Furnitures / Beds</p></a>
                        <h3 class="responsive">Wakefit Andromeda Sheesham Solid Wood King Bed </h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 15,000</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p51','Wakefit Sheesham Queen Bed',15000)"><b>Add to cart</b></a>   
                   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Wakefit Andromeda Sheesham Solid Wood King Bed  (Finish Color - Natural), Bed Material Subtype: Rosewood </p>
                     <p class="down">(Sheesham), W x H x D: 187.96 cm x 91.44 cm x 212.09 cm (6 ft 2 in x 3 ft x 6 ft 11 in), Recommended Mattress Size:</p> 
                     <p class="down">1981x1828, Delivery Condition: DIY - Basic assembly to be done with simple tools by the customer, comes with instructions.</p> 
                </div>
