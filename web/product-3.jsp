...
<head>
    ...
    <title>Samsung Galaxy S10 Lite</title>
   ...
   <%@include file="Navbar.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/phone1.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/phone1.jpeg" width="50px" height="100px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone1.1.jpeg" width="50px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone1.2.jpeg" width="40px" height="100px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/phone1.4.jpeg" width="40px" height="100px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                       <a href="Electronics-1.jsp"><p class="responsive1">Electronics / Mobiles</p></a>
                        <h3 class="responsive">Samsung Galaxy S10 Lite (Prism White, 128 GB)  (8 GB RAM)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 53,999</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    
                  <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p3'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Samsung Galaxy S10 Lite (Prism White, 128 GB)  (8 GB RAM) | Expandable Upto 1 TB , 17.02 cm</p>
                     <p class="down">(6.7 inch) Full HD+ Display, 48MP + 12MP + 5MP | 32MP Front Camera, 4500 mAh Lithium-ion</p> 
                     <p class="down">Battery , Qualcomm Snapdragon 855 (SM8150) Processor.</p> 
                </div>
