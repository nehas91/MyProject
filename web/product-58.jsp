...
<head>
    ...
    <title>Nike Navy Air Vibenna Sneakers</title>
    ...
    <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/shoe7.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe7.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe7.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe7.3.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe7.4.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Nike Men Navy Air Vibenna Sneakers Sneakers For Men  (Navy)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 6,499</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 9,999</small></strike><small class="change2"><b>&nbsp; 35% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p58','Nike Navy Air Vibenna Sneakers',6499)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Nike Men Navy Air Vibenna Sneakers Sneakers For Men (Navy), Color-Navy, Outer Material-Suede, Model Name-</p>
                     <p class="down">Men Navy Air Vibenna Sneakers, Ideal For-Men, Occasion-Casual, Sole Material-Rubber, Closure-Lace-Ups, Generic</p> 
                     <p class="down">Name-Shoe, Country of Origin-Indonesia.</p> 
                </div>
