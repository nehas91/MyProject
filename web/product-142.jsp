...
<head>
    ...
    <title>Cello Butterflow Simply Ball Pen</title>
    <link rel="stylesheet" href="Product_stationary1.css">
    ...
    <%@include file="Navbar_Stationary.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/pen7.jpeg" id="ProductImg14">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/pen7.jpeg" width="60px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen7.1.jpeg" width="50px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen7.2.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen7.jpeg" width="60px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Stationary-2.jsp">  <p class="responsive1">Stationaries / Pens</p></a>
                        <h3 class="responsive">Cello Butterflow Simply Ball Pen  (Pack of 50)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 449</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 500</small></strike><small class="change2"><b>&nbsp; 10% off</b></small></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                    <a href="" class="btnn" onclick="add_to_cart('p142','Cello Butterflow Simply Ball Pen',449)"><b>Add to cart</b></a>   
                       
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Cello Butterflow Simply Ball Pen  (Pack of 50), Brand: Cello, Body Color: Multicolor, It is Made of Plastic, Pack of 50</p>
                     <p class="down">Transparent Body Type, Smooth writing experience, Body Material Plastic, Designed in a way that give better grip</p> 
