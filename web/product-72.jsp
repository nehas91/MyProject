...
<head>
    ...
    <title>Reebok Men Grey Sports Sandal</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal8.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal8.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal8.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal8.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal8.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Reebok Men Grey Sports Sandal</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 1,407</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 2,199</small></strike><small class="change2"><b>&nbsp; 36% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p72','Reebok Men Grey Sports Sandal',1407)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Reebok Men Grey Sports Sandal, Type-Sports Sandals, Color-Grey Secondary Color-Grey, Leather Type-Napa</p>
                     <p class="down">The Reebok Flex Connect sandals for men, made with rubber outsole with textured footbed which provide </p> 
