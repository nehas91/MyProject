...
<head>
    ...
    <title>Puma Pacer Next Sneakers Black</title>
    ...
    <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/shoe3.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe3.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe3.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe3.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe3.5.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Puma Pacer Next FS Knit 2.0 Sneakers For Men  (Black, Orange)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 3,299</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p56','Puma Pacer Next Sneakers Black',3299)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Puma Pacer Next FS Knit 2.0 Sneakers For Men (Black, Orange), Color-Black, Orange, Outer Material-Mesh</p>
                     <p class="down">Model Name-Pacer Next FS Knit 2.0, this progressive street runner inspired sneaker features a knitted upper</p> 
                     <p class="down">that enhances breathability, and a heatcut formstripe that provides support, the midsole is of contempoary design.</p> 
                </div>
