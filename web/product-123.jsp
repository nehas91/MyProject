...
<head>
    ...
    <title>L'AVENIR Weight Dumbbell</title>
    ...
    <%@include file="Navbar_Sports.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/homegym11.jpeg" id="ProductImg8">
                        <div class="small-img-row" id="c4">
                            <div class="small-img-col">
                                <img src="images/homegym11.jpeg" width="70px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym11.1.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym11.2.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym11.jpeg" width="70px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change" id="c10">
                    <a href="Sports Items-2.jsp">  <p class="responsive1">Sports Items / Home gyms</p></a>
                        <h3 class="responsive">L'AVENIR Fitness Weight Dumbbell (Pack of 2)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 5,499</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                       <a href="" class="btnn" onclick="add_to_cart('p123','LAVENIR Weight Dumbbell',5499)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>L'AVENIR FITNESS PACK of 2 (15kg * 2 = 30kg) Professional HEXAGONAL Rubber coated Fixed Weight Dumbbell  (30 kg).</p>
                     <p class="down"> The Premium Quality Rubber Coated Professional HEXAGONAL Fixed Weight DUMBBELL have a Tough & Sturdy design</p> 
                     <p class="down">and comfortable feel. These DUMBBELLS are the ideal training aid for all types of workouts.</p> 
                </div>
