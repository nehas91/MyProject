...
<head>
    ...
    <title>Van Heusen Mask (Pack of 4)</title>
    ...
    <%@include file="Navbar_Covid19 care.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/mask2.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/mask2.jpeg" width="70px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/mask2.1.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/mask2.2.jpeg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/mask2.jpeg" width="70px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Covid19 Care-1.jsp">  <p class="responsive1">Covid19 Care / Masks</p></a>
                        <h3 class="responsive">Van Heusen Cloth Mask (Blue, Free Size, Pack of 4)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 389</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                     <a href="" class="btnn" onclick="add_to_cart('p90','Van Heusen Mask (Pack of 4)',389)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Van Heusen VHMSBRGB651658 Cloth Mask With Melt Blown Fabric Layer  (Blue, Free Size, Pack of 4), Mask Type-</p>
                     <p class="down">Half Mask, Respirator Type-NA, Mounting Type-Ear, Color-Blue, Suitable For-Fashionable Mask, Size-Free Size</p> 
                     <p class="down">Material-Cotton, Melt Blown Fabric Used.</p> 
                </div>
