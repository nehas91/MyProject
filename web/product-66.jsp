...
<head>
    ...
    <title>Sparx Men Black Color Sandal</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal3.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal3.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal3.3.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal3.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal3.5.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Sparx Men Black Color Sandal</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 1,899</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p66','Sparx Men Black Color Sandal',1899)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Sparx Men Black Color Sandal, Upper Pattern-Solid, Closure-Hook & Loop, Type for Flats-Sandal, Color-Black</p>
                     <p class="down">Removable Insole-No, Sole Material-EVA, Inner Material-Fabric. A perfect combination of comfort, style, and</p> 
                     <p class="down">workmanship. Its flaunting design pattern sparks a cool statement as you take a step ahead in them.</p> 
                </div>
