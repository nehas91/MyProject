...
<head>
    ...
    <title>Adorn India 5 Seater Sofa Set</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/sofa12.jpg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sofa12.jpg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa12.1.jpg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa12.2.jpg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa12.3.jpg" width="90px" height="80px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                       <a href="Furniture1.jsp"> <p class="responsive1">Furnitures / Sofa</p></a>
                        <h3 class="responsive">Adorn India Monteno Leatherette 5 Seater 3-1-1 Sofa Set (Black)</h3>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p38','Adorn India 5 Seater Sofa Set',28,999)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Adorn India Monteno Leatherette 5 Seater 3-1-1 Sofa Set (Black), Product dimension in cm Package 1 = Length </p>
                     <p class="down"> (193) Breadth (81)height (81) sitting height (40.64) Product dimension in cm Package 2 = Length (76) Breadth (81)</p> 
                     <p class="down">height (81) sitting height, Package 3 = 40.64 Length (76) Breadth (81)height (81) sitting height (40.64).</p> 
                </div>
