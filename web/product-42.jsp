...
<head>
    ...
    <title>Spacewood King Hydraulic Bed</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/bed2.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/bed2.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed2.1.jpeg" width="90px" height="80px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed2.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed2.3.jpeg" width="90px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Furniture2.jsp">  <p class="responsive1">Furnitures / Beds</p></a>
                        <h3 class="responsive">Spacewood Engineered Wood King Hydraulic Bed</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 29,790</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p42','Spacewood King Hydraulic Bed',29790)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Spacewood Engineered Wood King Hydraulic Bed  (Finish Color - Fumed Oak), Bed Material Subtype: Particle Board</p>
                     <p class="down">W x H x D: 190 cm x 95 cm x 222.8 cm (6 ft 2 in x 3 ft 1 in x 7 ft 3 in), Storage Type: Hydraulic, Recommended Mattress</p> 
                     <p class="down">Size: 183 X 200, Delivery Condition: Knock Down - Delivered in non-assembled pieces, installation by service partner</p> 
                </div>
