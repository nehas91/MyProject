...
<head>
    ...
    <title>Parker Odyssey Trim Ball Pen</title>
    ...
    <%@include file="Navbar_Stationary.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/pen4.jpeg" id="ProductImg13">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/pen4.jpeg" width="80px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen4.2.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen4.jpeg" width="80px" height="60px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen4.2.jpeg" width="60px" height="70px" class="change3">
                            </div>
                ...
                <div class="change" id="c13">
                      <a href="Stationary-2.jsp">  <p class="responsive1">Stationaries / Pens</p></a>
                        <h3 class="responsive">Parker Odyssey Laque Black Gold Trim Ball Pen</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 1,299</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                    <a href="" class="btnn" onclick="add_to_cart('p138','Parker Odyssey Trim Ball Pen',1299)"><b>Add to cart</b></a>   
                       
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Parker Odyssey Laque Black Gold Trim Ball Pen, Being modern, elegant and professional, the Parker Odyssey is a pen</p>
