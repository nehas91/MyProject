...
<head>
    ...
    <title>Asus ZenBook Pro Duo</title>
          ...
          <li><a href="#" data-toggle="modal" data-target="#cart"><i class="fa fa-shopping-basket"></i><span class="cart-items">( 0 )</span></a></li>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/laptop0.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/laptop0.jpeg" width="100px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop0.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop0.2.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop0.3.jpeg" width="100px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                       <a href="Electronics-2.jsp"><p class="responsive1">Electronics / Mobiles</p></a>
                        <h3 class="responsive">Asus ZenBook Pro Duo Core i7 9th Gen Laptop</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 2,29,800</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 2,39,990</small></strike><small class="change2"><b>&nbsp; 4% off</b></small></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     ...
                     <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p27'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Asus ZenBook Pro Duo Core i7 9th Gen - (32 GB/1 TB SSD/Windows 10 Home/6 GB Graphics) UX581GV</p>
                     <p class="down">-H7201T Laptop  (15.6 inch, Celestial Blue, 2.5 kg), Unleash your creative spirit by bringing home this beautiful</p> 
                     <p class="down">powerful laptop from ASUS. Featuring a 39.62 centimetre 4K NanoEdge  HDR display and ASUS ScreenPad Plus.</p> 
                </div>
