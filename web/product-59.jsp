...
<head>
    ...
    <title>Sparx SM-169 Mid Ankle Sneakers</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/shoe6.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe6.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe6.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe6.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe6.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Sparx SM-169 Mid Ankle Sneakers For Men  (Navy, White)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 2,180</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 5,199</small></strike><small class="change2"><b>&nbsp; 60% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p59','Sparx SM-169 Mid Ankle Sneakers',2180)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Sparx SM-169 Mid Ankle Sneakers For Men (Navy, White), Color-Navy,White, Outer Material-Synthetic Leather,</p>
                     <p class="down">Model Name-SM-169, Ideal For-Men, Occasion-Casual, Tip Shape-Round, Closure-Lace-Ups, Style-Raised Ankle</p> 
                     <p class="down">,Panel and Stitch Detail, Perforation Detail, Season-SS14.</p> 
                </div>
