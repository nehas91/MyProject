...
<head>
    ...
    <title>Asus VivoBook 14 Core i5</title>
           ...
           <li><a href="#" data-toggle="modal" data-target="#cart"><i class="fa fa-shopping-basket"></i><span class="cart-items">( 0 )</span></a></li>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/laptop2.jpeg" id="ProductImg">
                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="images/laptop2.jpeg" width="100px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop2.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop2.2.jpeg" width="50px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop2.3.jpeg" width="100px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                    <a href="Electronics-2.jsp"><p class="responsive1">Electronics / Mobiles</p></a>
                        <h3 class="responsive">Asus VivoBook 14 Core i5 10th Gen Thin and Light Laptop</h3>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     ...
                     <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p15'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Asus VivoBook 14 Core i5 10th Gen Thin and Light Laptop , Stylish & Portable Thin and Light Laptop</p>
                     <p class="down">14 inch Full HD LED Backlit Anti-glare Display (200 nits Brightness, 16:9 Aspect Ratio, 45% NTSC, 87% </p> 
                     <p class="down">Screen-to-body Ratio), Finger Print Sensor for Faster System Access, Laptop without Optical Disk Drive.</p> 
                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-3 feature-box5">
                               <a href="#"><img src="images/laptop2.jpeg" id="laptops"></a>
                                <div class="rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-3 feature-box6">
                                <a href="#"><img src="images/laptop3.jpeg" id="laptops1"></a>
                                <div class="rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-3 feature-box7">
                                <a href="#"><img src="images/laptop4.jpeg" id="laptops2"></a>
                                <div class="rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-3 feature-box8">
                                <a href="#"><img src="images/laptop6.jpeg" id="laptops3"></a>
                                <div class="rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
