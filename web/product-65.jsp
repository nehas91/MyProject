...
<head>
    ...
    <title>Adidas Men Navy Sandal</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal1.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal1.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal1.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal1.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal1.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                    <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Adidas Men Navy Sandal</h3>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p65','Adidas Men Navy Sandal',2999)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Adidas Men Navy Sandal, Closure-Velcro , Color-Navy, Sole Material-Rubber, Weight-500 g (per single Sandal)</p>
                     <p class="down">Weight of the product may vary depending on size. Good Quality and very Comfortable sandal, light weight</p> 
                     <p class="down">sandal.</p> 
                </div>
