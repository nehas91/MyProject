...
<head>
    ...
    <title>Reebok Floatride Running Shoes</title>
    ...
    <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/shoe11.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe11.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe11.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe11.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe11.3.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Reebok Floatride Run Fast Running Shoes For Men  (Grey)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 8,249</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p62','Reebok Floatride Running Shoes',8249)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Reebok Floatride Run Fast Running Shoes For Men (Grey), Built for speed, the Floatride Run Fast cushions feet</p>
                     <p class="down">while staying incredibly lightweight, Floatride foam stays responsive to your movements throughout your gait </p> 
                     <p class="down">cycle, providing support every step of the way.</p> 
                </div>
