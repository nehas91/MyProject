...
<head>
    ...
    <title>Bata Men Sports Blue Sandals</title>
    ...
    <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal6.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal6.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal6.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal6.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal6.2.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Bata Men Sports Blue Sandals</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 1,049</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 1,499</small></strike><small class="change2"><b>&nbsp; 30% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p70','Bata Men Sports Blue Sandals',1049)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Bata Men Sports Blue Sandals, Color-Blue, Ideal for-Men, Type-Sports Sandal, Ocassion-Casual. A good </p>
                     <p class="down">quality product with light weight , very comfortable to wear, and at a reasonable price, Manufactured by-</p> 
                     <p class="down">BATA INDIA LIMITED.</p> 
                </div>
