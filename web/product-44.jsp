...
<head>
    ...
    <title>Durian King Box Hydraulic Bed</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/bed4.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/bed4.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed4.1.jpeg" width="90px" height="80px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed4.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed4.3.jpeg" width="90px" height="80px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Furniture2.jsp">  <p class="responsive1">Furnitures / Beds</p></a>
                        <h3 class="responsive">Durian Mark-I Solid Wood King Box, Hydraulic Bed</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 59,280</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p44','Durian King Box Hydraulic Bed',59280)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Durian Mark-I Solid Wood King Box, Hydraulic Bed  (Finish Color - Frosty White::Dark Oak),Bed Material Subtype:</p>
                     <p class="down">Beech, W x H x D: 190 cm x 105 cm x 215 cm (6 ft 2 in x 3 ft 5 in x 7 ft), Storage Type: Box, Hydraulic, Recommended</p> 
                     <p class="down">Mattress Size: (L)1829mm X (W)1980mm, Delivery Condition: Knock Down - Delivered in non-assembled pieces, installation by service partner.</p> 
                </div>
