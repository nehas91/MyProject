...
<head>
    ...
    <title>Reebok Men Black Sports Sandal</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal5.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal5.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal5.2.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal5.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal5.jpeg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Reebok Men Black Sports Sandal</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 1,655</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 2,299</small></strike><small class="change2"><b>&nbsp; 28% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p69','Reebok Men Black Sports Sandal',1655)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Reebok Men Black Sports Sandal, The Reebok Royal Flex sandals with a lightweight Flex bottom and a stylish design,</p>
                     <p class="down">, this is the perfect sandal for everyday wear. Made with Lightweight Realflex outsole and EVA footbed which provide</p> 
                     <p class="down">added flexibility and comfort. The dual Velcro closure enables easy on and off.</p> 
                </div>
