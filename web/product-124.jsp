...
<head>
    ...
    <title>Kore PVC Home Gym Set</title>
     ...
     <%@include file="Navbar_Sports.jsp" %>            
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/homegym12.jpg" id="ProductImg8">
                        <div class="small-img-row" id="c4">
                            <div class="small-img-col">
                                <img src="images/homegym12.jpg" width="70px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym12.1.jpg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym12.2.jpg" width="70px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/homegym12.4.jpg" width="70px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change" id="c10">
                    <a href="Sports Items-2.jsp">  <p class="responsive1">Sports Items / Home gyms</p></a>
                        <h3 class="responsive">Kore PVC 20-50 Kg Home Gym Set</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 2,558</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                      <a href="" class="btnn" onclick="add_to_cart('p124','Kore PVC Home Gym Set',2558)"><b>Add to cart</b></a>   
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Kore PVC 20-50 Kg Home Gym Set with One 5 Ft Plain + One 3 Ft Curl and One Pair Dumbbell Rods, 30 kg of PVC weight</p>
                     <p class="down"> (2.5 kg x 4 = 10 kg + 5 kg x 4 = 20 kg) 1 x 5 feet plain rod + 1 x 3 feet curl rod + 2 x 14 inch dumbbell rods, 4 locks and</p> 
                     <p class="down">clippers comes with the rods, It is highly durable and long lasting.</p> 
                     </div>
