...
<head>
    ...
    <title>Nike Men's Air Force 1 Shoes</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/shoe10.jpg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe10.jpg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe10.1.jpg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe10.2.jpg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe10.3.jpg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Nike Men's Air Force 1 '07 Leather Basketball Shoes</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 7,295</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p64','Nike Mens Air Force 1 Shoes',7295)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Nike Men's Air Force 1 '07 Leather Basketball Shoes, Closure: Lace-Up, Shoe Width: Medium, Material Type:</p>
                     <p class="down">Leather, Lifestyle: Sports, Closure Type: Lace-Up, Care Instructions: Allow your pair of shoes to air and de-odorize</p> 
                     <p class="down">at a regular basis, this also helps them retain their natural shape; use shoe bags to prevent any stains or mildew.</p> 
                </div>
