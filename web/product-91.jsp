...
<head>
    ...
    <title>Pace International 3 Ply Face Mask</title>
    ...
    <%@include file="Navbar_Covid19 care.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/mask3.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/mask3.jpeg" width="70px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                            ...
                            <div class="small-img-col">
                                <img src="images/mask3.jpeg" width="70px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Covid19 Care-1.jsp">  <p class="responsive1">Covid19 Care / Masks</p></a>
                        <h3 class="responsive">Pace International 3 Ply Face Mask (Free Size, Pack of 100, 3 Ply)</h3>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     ...
                     <a href="" class="btnn" onclick="add_to_cart('p91','Pace International 3 Ply Face Mask',240)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Pace International Health+Surgical Face Mask, 3 Ply mask with Melt Blown Fabric Layer Disposable 3 Ply Pharmaceutical </p>
                     <p class="down">Breathable Surgical Pollution Face Mask Respirator with 3 Layer For Men, Women, Kids SGM Surgical Mask (Free Size,</p> 
                     <p class="down">Pack of 100, 3 Ply).</p> 
                </div>
