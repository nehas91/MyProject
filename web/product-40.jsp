...
<head>
    ...
    <title>Dream Furniture Fabric 2 Seater Sofa</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/sofa0.0.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sofa0.0.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa0.1.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa0.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sofa0.0.jpeg" width="90px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">Dream Furniture Fabric 2 Seater Sofa Color - Mustard Yellow</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 34,955</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p40','Dream Furniture Fabric 2 Seater Sofa Color - Mustard Yellow ',34955)"><b>Add to cart</b></a>   
                                       <h5 class="down1"><b>Product description:</b></h5>
                    <p>Dream Furniture Fabric 2 Seater Sofa  (Finish Color - Mustard Yellow), Presenting stylish and classy furniture</p>
                     <p class="down">designs from the house of Dream Furniture, The brand offers unique and innovative designs with high quality</p> 
                     <p class="down">material and intricate details.</p> 
                </div>
