...
<head>
    ...
    <title>Parker Odyssey Gold Ball Pen</title>
    ...
    <%@include file="Navbar_Stationary.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/pen12.jpeg" id="ProductImg13">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/pen12.jpeg" width="80px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen12.2.jpeg" width="60px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen12.jpeg" width="80px" height="60px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/pen12.2.jpeg" width="60px" height="70px" class="change3">
                            </div>
                ...
                <div class="change" id="c13">
                      <a href="Stationary-2.jsp">  <p class="responsive1">Stationaries / Pens</p></a>
                        <h3 class="responsive">Parker Odyssey Brushed Metal Gold Trim Ball Pen</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 1,360</strong></h4>
                    <p class="avail"><b>Availability:</b> In Stock</p>
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                    
                    <a href="" class="btnn" onclick="add_to_cart('p147','Parker Odyssey Gold Ball Pen',1360)"><b>Add to cart</b></a>   
                       
                    
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Parker Odyssey Brushed Metal Gold Trim Ball Pen, Being modern, elegant and professional, Parker Odyssey is a pen</p>
                     <p class="down">that will amp up your style quotient. Apart from its stylish looks, this ball pen can deliver an incredibly smooth and</p> 
                     <p class="down">intense writing experience. This elegant ball pen features successive coats of glossy black lacquer for rich,deep brilliance.</p> 
                </div>
