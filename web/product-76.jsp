...
<head>
    ...
    <title>Camel Crown Men Hiking Sandals</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/sandal10.jpg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/sandal10.jpg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal10.3.jpg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal10.2.jpg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/sandal10.jpg" width="90px" height="50px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear2.jsp">  <p class="responsive1">Footwears / Sandals</p></a>
                        <h3 class="responsive">Camel Crown Men Hiking Sandals</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 3,849</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p76','Camel Crown Men Hiking Sandals',3849)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Camel Crown Men Hiking Sandals, Mens leather sandals made of high-quality genuine nubuck leather, matching</p>
                     <p class="down">with elastic fabric and air holes,fahional and breathable, Closed toe sandals with rubber toe cap, help prevents</p> 
                     <p class="down">unexpected crash,ensure your safety during outdoor activities.</p> 
                </div>
