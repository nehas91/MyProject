...
<head>
    ...
    <title>Urban Ladder King Box Bed</title>
    ...
    <%@include file="Navbar_furniture.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/bed6.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/bed6.jpeg" width="90px" height="80px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed6.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed6.2.jpeg" width="90px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/bed6.3.jpeg" width="100px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Furniture2.jsp">  <p class="responsive1">Furnitures / Beds</p></a>
                        <h3 class="responsive">Urban Ladder Dixon Solid Wood King Box Bed </h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star-half-o"></i>
                    <h4 class="rate"><strong>&#8377; 48,747</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 60,797</small></strike><small class="change2"><b>&nbsp; 20% off</b></small></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p46','Urban Ladder King Box Bed',48,747)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Urban Ladder Dixon Solid Wood King Box Bed  (Finish Color - Dark Walnut), Bed Material Subtype: Rubber Wood</p>
                     <p class="down">W x H x D: 189.992 cm x 111.252 cm x 228.6 cm (6 ft 2 in x 3 ft 7 in x 7 ft 6 in), Storage Type: Box, Recommended </p> 
                     <p class="down">Mattress Size: 1981.2 x 1828.8, Delivery Condition: Knock Down - Delivered in non-assembled pieces, installation by service partner.</p> 
                </div>
