...
<head>
    ...
    <title>Skechers Walking Shoes Black</title>
     ...
     <%@include file="Navbar_footwear.jsp" %>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                            <img src="images/shoe4.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/shoe4.jpeg" width="110px" height="60px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe4.4.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe4.1.jpeg" width="90px" height="55px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/shoe4.3.jpeg" width="90px" height="60px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                      <a href="Footwear1.jsp">  <p class="responsive1">Footwears / Shoes</p></a>
                        <h3 class="responsive">Skechers BOUNDER-STOKLEY Walking Shoes For Men  (Black)</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 3,603</strong></h4>
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('p54','Skechers Walking Shoes Black',3603)"><b>Add to cart</b></a>   
                   
                    <h5 class="down1"><b>Product description:</b></h5>
                    <p>Skechers BOUNDER-STOKLEY Walking Shoes For Men (Black), Color-Black, Outer Material-
                        Fabric, Model Name-</p>
                     <p class="down">BOUNDER-STOKLEY, Ideal For-Men, Occasion-Sports, Closure-
                        Lace-Ups, Upper Pattern-Mesh. This is an authentic</p> 
                     <p class="down">product of Skechers South Asia Pvt. Ltd. The product comes with a standard brand warranty of 90 days.</p> 
                </div>
