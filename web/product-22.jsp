...
<head>
    ...
    <title>Apple MacBook Pro Core i5</title>
          ...
          <li><a href="#" data-toggle="modal" data-target="#cart"><i class="fa fa-shopping-basket"></i><span class="cart-items">( 0 )</span></a></li>
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <div class="pr">
                        <img src="images/laptop7.jpeg" id="ProductImg">
                        <div class="small-img-row" id="change1">
                            <div class="small-img-col">
                                <img src="images/laptop7.jpeg" width="100px" height="70px" class="change3" id="change4">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop7.1.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop7.2.jpeg" width="100px" height="70px" class="change3">
                            </div>
                            <div class="small-img-col">
                                <img src="images/laptop7.3.jpeg" width="100px" height="70px" class="change3">
                            </div>
                        </div>
                ...
                <div class="change">
                        ...
                        <h3 class="responsive">Apple MacBook Pro with Touch Bar Core i5 10th Gen Laptop</h3>
                        <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <h4 class="rate"><strong>&#8377; 173,990</strong> <strike class="ike"><small class="change1">&nbsp;&#8377; 192,390</small></strike><small class="change2"><b>&nbsp; 10% off</b></small></h4>
                    ...
                    <p class="quant"><b>Quantity: </b><input type="number" value="1"></p>
                     ...
                     <%
                            String ptitle="",pid="";
                            int pprice=0;
                            ResultSet rs=DatabaseBean.executeQuery("select pid,ptitle,pprice from product where pid='p22'");
                            while(rs.next())
                            {
                   ...
                   <a href="" class="btnn" onclick="add_to_cart('<%= pid %>','<%=ptitle%>',<%=pprice%>)"><b>Add to cart</b></a>   
                    ...
                    <p>Apple MacBook Pro with Touch Bar Core i5 10th Gen - (16 GB/512 GB SSD/Mac OS Catalina) MWP42HN</p>
                     <p class="down">/A  (13 inch, Space Grey, 1.4 kg), Stylish & Portable Thin and Light Laptop, 13 inch Full HD+ LED Backlit IPS </p> 
                     <p class="down">Retina Display (227 PPI, 500 nits Brightness, Wide Color (P3), True Tone Technology).</p> 
                </div>
